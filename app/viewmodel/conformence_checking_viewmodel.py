...
class ConformanceCheckingViewModel:
    ...
    def set_model_log_loaded(self, loaded, model_log: Model):
        self.event_log_loaded = loaded
        self.event_log = model_log
        self.model_dcr_graph, _ = model_log
    ...
    def set_active_model_log(self, model_log: Model):
        self.active_event_log = model_log

    def rule_conformance_checking(self):
        conformance_df = conformance_dcr(self.active_event_log, self.model_log.model, return_diagnostics_dataframe=True)
    ...
    def alignment_conformance_checking(self):
        ...
        alignment_sepsis_df = pm4py.optimal_alignment_dcr(self.active_event_log, self.event_dcr_graph, return_diagnostics_dataframe=True)
